...
user_number = 1
while True:
    cprint('Текущая позиция камней', color='cyan')
    cprint(get_bunches(), color='cyan')
    ...
    if step_successed:
        ...
        cprint('Невозможный ход!', color='white')

cprint('Выиграл игрок номер {}'.format(user_number), color='magenta')